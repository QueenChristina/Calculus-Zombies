...
pygame.display.set_caption('Calculus Zombies')
...
class Sprite(pygame.sprite.Sprite):
    ...
    def imagerect(self):
        ...
        self.colliderect = pygame.Rect(self.rect.top, self.rect.left, 2*self.rect.width/3, self.rect.height/2)
...
Player = Player(imgPerson, 2/3 , (int(DISPLAY_X/2 - 8), int(DISPLAY_Y/2)), False)
Player.dx = 3
Player.dy = 3
