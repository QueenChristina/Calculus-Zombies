...
def listimages(path, totalimages):
    ...
    listimages =[os.path.join(path, '000.png'), os.path.join( path, '001.png'), os.path.join(path, '002.png'), os.path.join(path, '003.png'),
        ...
        os.path.join(path, '016.png'), os.path.join(path, '017.png'),os.path.join(path, '018.png'),os.path.join(path, '019.png'),
        os.path.join(path, '020.png'), os.path.join(path, '021.png'),]
